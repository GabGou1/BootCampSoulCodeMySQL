...
-- Como montar uma tabela que mostra nome, preco e o nome da categoria?
SELECT nome, email, uf, cidade -- Podemos escolher quais colunas exibir na junção
FROM vendedor
	JOIN endereco
    ON idVendedor = fkVendedor; -- Oque faz o vinculo entre as tabelas
...
SELECT P.nome, P.preco, P.descricao, C.nome AS categoria
FROM categoria AS C
	JOIN produto AS P
